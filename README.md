...
|:---:|---|---|---|
| <img src="easy-checkout/img/extension.png" width="120"> | **[Easy Checkout](easy-checkout)** ⭐ | One-page checkout with a drag-and-drop page builder, custom fields, and shipping/payment control. | [Download](https://github.com/AlexWaha/opencart-bundle/blob/master/easy-checkout/dist/aw_easy_checkout_oc2.3-3.x.ocmod.zip) · [Docs](easy-checkout/docs/en.md) |
...
| <img src="global-layout/img/extension.png" width="120"> | **[Global Layout](global-layout)** | Inject site-wide HTML/CSS/JS and layout tweaks from the admin. | [Download](https://github.com/AlexWaha/opencart-bundle/blob/master/global-layout/dist/aw_global_layout_oc2.3-3x.ocmod.zip) · [Docs](global-layout/docs/en.md) |
| <img src="faq/img/extension.png" width="120"> | **[FAQ](faq)** | Frequently Asked Questions blocks for products and pages. | [Download](https://github.com/AlexWaha/opencart-bundle/blob/master/faq/dist/aw_faq_oc2.3-3.x.ocmod.zip) · [Docs](faq/docs/en.md) |
