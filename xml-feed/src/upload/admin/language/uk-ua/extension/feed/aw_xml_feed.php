...
$_['entry_show_delivery_info'] = 'Виводити інформацію про доставку';
...
$_['help_show_delivery_info'] = 'Включає/відключає виведення блоків доставки у всіх XML фідах модуля';
$_['help_delivery_service'] = 'Назва служби доставки або спосіб доставки';
$_['help_delivery_days'] = 'Кількість днів доставки (1-365)';
$_['help_delivery_price'] = 'Ціна доставки, 0 для безкоштовної доставки';
