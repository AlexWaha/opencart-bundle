...
$_['text_feed_generation_url'] = 'Ссылка для генерации фида';
...
$_['entry_show_delivery_info'] = 'Выводить информацию о доставке';
$_['entry_delivery_service'] = 'Служба доставки';
$_['entry_delivery_days'] = 'Срок доставки в днях';
$_['entry_delivery_price'] = 'Цена доставки';
...
$_['help_show_delivery_info'] = 'Включает/отключает вывод блоков доставки во всех XML фидах модуля';
$_['help_delivery_service'] = 'Название службы доставки или способ доставки';
$_['help_delivery_days'] = 'Количество дней доставки (1-365)';
$_['help_delivery_price'] = 'Цена доставки, 0 для бесплатной доставки';
...
$_['help_feed_generation'] = 'Скопируйте эту ссылку для ручного запуска генерации XML фида. Для автоматизации через cron используйте: <code>php /path/to/your/site/cli/aw_xml_feed.php</code>';
...
$_['error_delivery_days'] = 'Срок доставки должен быть от 1 до 365 дней.';
$_['error_delivery_price'] = 'Цена доставки должна быть положительным числом.';

// Delivery text templates
$_['text_delivery_info'] = 'Доставка %s дней';
$_['text_delivery_info_with_price'] = 'Доставка %s дней, стоимость %s';
