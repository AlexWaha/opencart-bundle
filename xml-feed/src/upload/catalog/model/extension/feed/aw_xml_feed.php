...
class ModelExtensionFeedAwXmlFeed extends Model
{
    ...
    public function getWeightUnit($weightClassId, $languageId)
    {
        $query = $this->db->query("SELECT unit FROM " . DB_PREFIX . "weight_class_description WHERE weight_class_id = '" . (int)$weightClassId . "' AND language_id = '" . (int)$languageId . "'");
