...
$_['entry_shipping_text'] = 'Статичний текст - Доставка';
...
$_['help_attribute_shipping'] = 'Атрибут товару з вказанням термінів доставки';
...
$_['help_shipping_text'] = 'Вкажіть інформацію про терміни доставки, наприклад: Доставка 1-3 дні';
...
$_['error_shipping_text'] = 'Вкажіть текст доставки (від 3 до 255 символів).';
