...
$_['text_import_export_info']  = 'Экспортируйте текущую конфигурацию отслеживания в JSON-файл или импортируйте ранее сохранённую конфигурацию.';
$_['text_export_description']  = 'Скачать текущую конфигурацию отслеживания в формате JSON.';
$_['text_import_description']  = 'Выберите ранее экспортированный JSON-файл для восстановления настроек отслеживания.';
$_['text_import_warning']      = '<strong>Внимание!</strong> Импорт перезапишет все текущие настройки отслеживания. Это действие нельзя отменить.';
...
$_['text_diag_events_missing'] = 'Некоторые события отсутствуют — переустановите модуль';
$_['text_diag_events_count']   = 'События: %s/%s зарегистрировано';
$_['text_diag_config_ok']      = 'Все обязательные поля заполнены';
$_['text_diag_config_missing'] = 'Некоторые рекомендуемые поля пусты';
$_['text_diag_missing_fields'] = 'Отсутствующие рекомендуемые поля';
$_['text_diag_failed']         = 'Не удалось загрузить диагностику';
$_['text_diag_event_ok']       = 'OK';
$_['text_diag_event_missing']  = 'ОТСУТСТВУЕТ';
$_['text_diag_go_to_tab']      = 'Перейти к настройкам →';
...
$_['error_import_read_file'] = 'Невозможно прочитать загруженный файл';
