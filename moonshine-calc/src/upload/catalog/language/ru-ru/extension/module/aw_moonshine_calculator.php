...
$_['text_reset']             = 'Очистить';
$_['text_result']            = 'Результат расчета';
$_['text_instructions']      = 'Инструкция по использованию';
$_['text_home']              = 'Главная';
...
$_['error_initial_strength_range'] = 'Начальная крепость должна быть от 0 до 100%!';
...
$_['text_description_default']     = 'Введите исходные данные:';

// JavaScript messages
$_['text_calculating']             = 'Расчет...';
$_['text_error_unknown']           = 'Произошла неизвестная ошибка при расчете';
$_['text_error_general']           = 'Произошла ошибка при расчете. Попробуйте еще раз.';
